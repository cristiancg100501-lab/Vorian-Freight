  ...
  useEffect(() => {
    ...
    el.innerHTML = `
      <div style="position: relative; display: flex; flex-direction: column; items-center; justify-content: center; align-items: center;">
        <div style="width: 32px; height: 32px; background-color: #ef4444; border-radius: 50%; box-shadow: 0 4px 10px rgba(239,68,68,0.4); border: 3px solid #fff; display: flex; align-items: center; justify-content: center; z-index: 10;">
          <div style="width: 10px; height: 10px; background-color: #fff; border-radius: 2px;"></div>
        </div>
        <div style="width: 3px; height: 18px; background-color: #ef4444; margin-top: -2px; z-index: 1;"></div>
        <div style="width: 12px; height: 4px; background-color: rgba(239,68,68,0.3); border-radius: 50%; filter: blur(1px); margin-top: -2px;"></div>
      </div>`;
